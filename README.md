...
### Overview
In your project's Gruntfile, add a section named `terminus` to the data object passed into `grunt.initConfig()`.
...
## License
Copyright (c) 2015 Jake Love. Licensed under the MIT license.
